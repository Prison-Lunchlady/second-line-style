...
// Delisted from the storefront but kept here (with Shopify variant IDs) so the
// product data is preserved and can be re-listed later without recreation.
const HIDDEN_PRODUCTS: Omit<Product, "slug">[] = [
  {
