...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Common questions about a Louisiana apparel brand: who we are, where we're based, limited releases, and upcoming city collections." },
